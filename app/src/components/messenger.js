...
export default class Messenger extends Component {
    ...
    handleSendLoca() {
        var locitem = this.successlocation();
        var nnewMessage = navigator.geolocation.getCurrentPosition(locitem);
        const  newMessage = this.state ;
        const { store } = this.props;

        //newMessage = nnewMessage;
         console.log(nnewMessage);
        
        // create new message

        if (_.trim(nnewMessage).length) {
                ...
                <div className="header">
                    ...
                    <div className="content">
                        ...
                        {_.get(activeChannel, 'isNew') ? <div className="toolbar">
                            ...
                            }} type="text" className="search-txt" value={this.state.searchUser} />
                                ...
                                return (
                                    <div onClick={(key) => {
                                        ...
                                        <div className="chanel-info">
                                            ...
                                            <div className="right">
                                            <div align="right" className="chanel-date">{moment(_.get(channel, 'updated')).format('LT')}</div></div>
                                        </div>
                    ...
                    <div className="content">
                                    ...
                                    <div key={index} className={classNames('message', { 'me': message.me })}>
                                        ...
                                        <div className="message-body">
                                            ...
                                            <div className="message-text">
                                                ...
                                                {moment(_.get(message, 'created')).format('LT')}
                                            </div>
                                        </div>
                                    </div>
                                )
                        ...
                        {activeChannel && members.size > 0 ? <div className="messenger-input">
                            ...
                            <div className="text-input">
                                <textarea id="textmaster" onKeyUp={(event) => {
                            ...
                            <div className="actions">
                                ...
                                <button onClick={this.handleSendLocation} className="location"><i className="icon-location" /></button>
                                    ...
                                    return (
                                        <div key={key} className="member">
                                            ...
                                            <div className="member-info">
                                                ...
                                                <p>Last seen: {moment(member.created).fromNow()}</p>
                                            </div>
